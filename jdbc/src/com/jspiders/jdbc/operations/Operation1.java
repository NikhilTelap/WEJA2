...
public class Operation1 {
	...
	private static void CreateTable() {
		...
		try {
		OpenConnection();
		query="CREATE TABLE emp(empno INT,ename VARCHAR(50) NOT NULL,job VARCHAR(50),mgr VARCHAR(50),hiredate DATE NOT NULL ,sal INT NOT NULL,comm INT,PRIMARY KEY(empno))";
